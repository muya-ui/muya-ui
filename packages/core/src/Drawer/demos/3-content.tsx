...
export default function CustomContent() {
  ...
  return (
    <div>
      <Drawer direction={direction} open={open} onClose={() => setOpen(false)}>
        <Dialog.Title closeButtonSize="xl">漂亮的标题</Dialog.Title>
        <Table<Album> columns={columns} dataSource={albums} rowKey="title" />
      </Drawer>
      <Button
        onClick={() => {
          setDirection('up');
...
export const meta = {
  title: '复杂内容',
  desc: '顶部使用`Dialog.Title`作为标题，内容部分使用`Table`',
};
