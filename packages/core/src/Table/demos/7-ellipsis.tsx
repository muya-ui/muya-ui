...
export const meta = {
  title: '单元格自动省略',
  desc:
    '1. 设置 `column.ellipsis` 可以让单元格内容根据宽度自动省略。\n\n 2. 设置`column.ellipsisTooltip`，可以配置省略文本是否展示Tooltip \n\n 3. 设置`Table`组件的`ellipsis`，可以预设`column.ellipsis`的默认值',
};
