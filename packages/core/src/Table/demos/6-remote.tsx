...
import { UnwellIcon } from '@muya-ui/theme-light';
import { Button, Img, ITableColumn, Table } from '@muya-ui/core';
...
export const meta = {
  title: '远程加载数据',
  desc:
    '1. 通过设置`emptyText`可以自定义表格空状态的内容 \n\n 2. 通过设置`loading`属性可以自定义表格的加载状态',
};
